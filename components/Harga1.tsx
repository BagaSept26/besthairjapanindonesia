...
const Harga = () => {
  ...
  return (
    <div style={{ perspective: 2000 }} className=' mx-auto px-11 text-center'>
      {/* card */}
      <motion.div
        ...
        className=' mx-auto text-center mt-28 bg-[#faebd7] rounded-[30px] border-[4px] border-white px-[40px] py-[24px] cursor-grab relative '
      >
        {/* card logo */}
        <div className='mb-6'>
        ...
        {/* card title */}
        <h1 className='text-4xl mb-6 font-extrabold'>TRANSPLANTASI Rambut</h1>
        {/* card subtitle */}
